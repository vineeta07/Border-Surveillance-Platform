...
SIH26187 – AI-Based Intelligent Video Analytics Platform for Border Surveillance using Existing CCTV Infrastructure Organization: Ministry of Home Affairs · Department: Sashastra Seema Bal (SSB), Police II Division · Theme: Blockchain & Cybersecurity
...
reportlab/weasyprint (PDF export), python-pptx (PPT export)
📂 Project Structure
Border-Surveillance-/
│
├── frontend/
...
4. Configure environment variables Create .env.local in frontend/ and .env in backend/ — adjust names to match your actual config:
...
Project Name: IBVAP – Intelligent Border Video Analytics Platform Problem Statement: SIH26187 – AI-Based Intelligent Video Analytics Platform for Border Surveillance using Existing CCTV Infrastructure Team: Team Drishti Event: Smart India Hackathon 2026
...
Team Drishti Built for Smart India Hackathon 2026.
